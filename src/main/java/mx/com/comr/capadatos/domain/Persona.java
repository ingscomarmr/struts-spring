package mx.com.comr.capadatos.domain;
...
public class Persona {	
	...
	@Id
	@SequenceGenerator(name="my_persona_seq", sequenceName="PERSONASEQUENCE")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="my_persona_seq")
